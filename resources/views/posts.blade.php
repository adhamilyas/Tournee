            ...
            <form action="/posts">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button class="btn text-white" style="background-color: #0F4C75" type="submit">Search</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="card-body text-center">
                ...
                <small class="text-muted">
                    <p>By: <a href="/posts?author={{ $posts[0]->author->username }}"
                            ...
                            {{ $posts[0]->category->name }}</a> {{ $posts[0]->created_at->diffForHumans() }} </p>
                </small>
                <p class="card-text">{{ $posts[0]->excerpt }}</p>

                <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn text-white"
                    style="background-color: #0F4C75">Read more</a>
            </div>
        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/posts/{{ $post->slug }}" class="text-decoration-none btn text-white"
                                    style="background-color: #0F4C75">Read more</a>
                            </div>
                        </div>
                    </div>
